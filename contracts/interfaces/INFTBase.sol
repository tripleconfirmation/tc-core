...
interface INFTBase /* is ERC165 */ {
    ...
    function level() external view returns (uint8 level);

    // function getTokenIdsOf(address account) external view returns (uint[] memory);

    // function _getTokenIdsOf(address account, bytes1 operation) external view returns (uint[] memory);

    function NFTs() external view returns (NFTStructs.NFT memory NFTs);

    function totalSupply() external view returns (uint totalCreated);
    ...
    function tokenURI(uint _tokenId) external view returns (string memory uri);
    ...
    function getApproved(uint _tokenId) external view returns (address approved);
    ...
    function isApprovedForAll(address _owner, address _operator) external view returns (bool _approvedForAll);
